...
pub(super) struct ViewState {
    ...
    syncing_child_preview: Cell<bool>,
    pending_child_preview: RefCell<Option<glib::SourceId>>,
    last_child_preview: Cell<Option<std::time::Instant>>,
...
impl BrowserView {
    ...
    fn with_options(
        ...
        let state = Rc::new(ViewState {
            ...
            syncing_child_preview: Cell::new(false),
            pending_child_preview: RefCell::new(None),
            last_child_preview: Cell::new(None),
            multiple_selection,
            interactive,
